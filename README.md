...
<img src="https://agi-prod-file-upload-public-main-use1.s3.amazonaws.com/111dadc9-df9e-4dfc-9f0f-3bb01d354739" width="800" alt="n8n Workflow">
...
<img src="https://agi-prod-file-upload-public-main-use1.s3.amazonaws.com/474e9fd7-e033-4e86-a863-c8bce4c32a2f" width="800" alt="Database Schema">
...
<img src="https://agi-prod-file-upload-public-main-use1.s3.amazonaws.com/fdbecc13-e2f7-4a38-b84b-badb70b97d37" width="800" alt="Data Cleaning Process">
...
<img src="https://agi-prod-file-upload-public-main-use1.s3.amazonaws.com/2f88008f-f890-4c25-87bf-2dcb28801e0d" width="800" alt="Business Questions Analysis">
...
\begin{enumerate}
\item \textbf{Clear Business Problem Definition} - Understanding actual operational pain points enabled targeted solution design
\item \textbf{Modern Tool Stack Selection} - Cloud-based, AI-powered tools enabled rapid development
\item \textbf{Automation-First Mindset} - Eliminating manual handling freed time for strategic analysis
\item \textbf{Iterative Development} - Building incrementally allowed testing and refinement
\end{enumerate}
...
\begin{itemize}
\item Stabilize fulfillment for \textbf{Beverages and Dairy} categories
\item Track lead time variability \textbf{weekly} instead of monthly
\item Improve OTIF through \textbf{city-specific distribution adjustments}
\item Introduce \textbf{weekly alerts} for demand surges
\item Address \textbf{non-metro inventory allocation} issues
\end{itemize}
...
🛠️ **Proficiency**: n8n • Supabase • Quadratic • Python • SQL • PostgreSQL
